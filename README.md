...
* `/data/`: Directory where the training and testing images are located.
* `/checkpoints/`: Directory for saving and loading model weights during the training process.
